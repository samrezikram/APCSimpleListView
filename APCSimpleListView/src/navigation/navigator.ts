...
export class Navigator {
  ...
  public static async setRequestRepositoryAsRoot(): Promise<any> {
    const rootId: string = `${NavigationRoot.MAIN_ROOT}_${generateUniqueID()}_${Navigator.getNavigationCount()}`;
    const rootScreenId: string = `${ScreenRoute.REQUEST_GITHUB_REPO_SCREEN}_${generateUniqueID()}_${Navigator.getNavigationCount()}`;
    return Navigation.setRoot({
      root: {
        stack: {
          id: rootId,
          children: [
            {
              component: {
                id: rootScreenId,
                name: ScreenRoute.REQUEST_GITHUB_REPO_SCREEN
              }
            }
          ]
        }
      ...
      Navigator.navigationHistory = {
        ...
        stack: [{
          id: rootScreenId,
          type: RouteType.SCREEN,
          route: ScreenRoute.REQUEST_GITHUB_REPO_SCREEN,
          passedProps: null
        }, ...currentOvrelays]
      };
